...
--[[-------------------------------------------------------------------
  ...
  Copyright (c) 2011 Cory Burgett <cmburget@ncsu.edu>
  ...
  http://github.com/baguette/lemma  (Cory Burgett)
...
CONFIGURATION = {
  ...
  ["amd64"] = {
    description = "(64-bit, little endian, doubles)",
    endianness = 1,
    size_int = 4,
    size_size_t = 8,
    size_Instruction = 4,
...
SetProfile("amd64") -- default profile
